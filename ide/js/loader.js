...
function(e) {
    var t = function() {
            ...
            return e.prototype.load = function(e, t, i, s) {
                ...
                this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(a) : (this._callbackMap[t] = [a], this._scriptLoader.load(e, t, (function() { return d.triggerCallback(t) }), (function(e) { return d.triggerErrorback(t, e) })))
        ...
        o = function() {
            ...
            return t.prototype._init = function(e) { this._didInitialize || (this._didInitialize = !0, this._fs = e("fs"), this._vm = e("vm"), this._path = e("path"), this._crypto = e("crypto")) }, t.prototype._initNodeRequire = function(e, t) {
                ...
                if (/^node\|/.test(n)) {
                    var c = n.split("|"),
                        h = null;
                    try { h = a(c[1]) } catch (e) { return void i(e) }
            ...
            }, t.prototype._getElectronRendererScriptPathOrUri = function(e) { if (!this._env.isElectronRenderer) return e; var t = e.match(/^([a-z])\:(.*)/i); return t ? "file:///" + (t[1].toUpperCase() + ":" + t[2]).replace(/\\/g, "/") : "file://" + e }, t.prototype._getCachedDataPath = function(e, t) {
                ...
                var o = this,
                    ...
                    u = function() {
                        setTimeout((function() {
                            ...
                            0 === i.length || i.length === s || d >= 5 || (s = i.length, o._fs.writeFile(r, Buffer.concat([a, i]), (function(e) { e && n.getConfig().onError(e), n.getRecorder().record(63, r), u() })))
                        }), i * Math.pow(4, d++))
                    };
                u()
                ...
                if (t) {
                    ...
                    this._fs.readFile(e, { encoding: "utf8" }, (function(e, t) { o = t, a(e) })), this._fs.readFile(t, (function(e, n) {!e && n && n.length > 0 ? (s = n.slice(0, 16), i = n.slice(16), r.record(60, t)) : r.record(61, t), a() }))
            ...
            s.prototype.getGlobalAMDDefineFunc = function() { return this._defineFunc }, s.prototype.getGlobalAMDRequireFunc = function() { return this._requireFunc }, s._findRelevantLocationInStack = function(e, t) {
                for (var r = function(e) { return e.replace(/\\/g, "/") }, n = r(e), o = t.split(/\n/), i = 0; i < o.length; i++) {
                    ...
                    if (s) {
                        ...
                        if ((d = r(d = d.substr(l))) === n) { var c = { line: parseInt(a, 10), col: parseInt(u, 10) }; return 1 === c.line && (c.col -= "(function (require, define, __filename, __dirname) { ".length), c }
                    }
                }
                ...
                var r = this,
                    n = function(e, n, o) { return r._relativeRequire(t, e, n, o) };
                            ...
                            if (d !== o.MODULE)
                                if (d !== o.REQUIRE) {
                                    ...
                                    if (a && a.isComplete()) {
                                        ...
                                        if (l && l.isComplete()) { this._loadPluginDependency(l.exports, d); continue }
...
function(e) {
    ...
    var o = function(e, t) { void 0 === t && (t = !1), r.configure(e, t) },
        i = function() {
            if (1 === arguments.length) { if (arguments[0] instanceof Object && !Array.isArray(arguments[0])) return void o(arguments[0]); if ("string" == typeof arguments[0]) return r.synchronousRequire(arguments[0]) }
