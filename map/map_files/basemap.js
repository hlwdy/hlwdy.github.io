...
L.TileLayer.ChinaProvider.providers = {
    GaoDe: {
        Normal: {
            Map: autohttps('http://webrd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}')
        },
        Satellite: {
            Map: autohttps('http://webst0{s}.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}'),
            Annotion: autohttps('http://webst0{s}.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}')
        },
        Subdomains: ["1", "2", "3", "4"]
    },
